...
class DashPage {
    ...
    selectDay(appointmentDate) {
        ...
        let today = new Date()
        let lasdayOfMonth = new Date(today.getFullYear(), today.getMonth() + 1, 0) //pega o ultimo dia do mes

        if(today.getDate() === lasdayOfMonth.getDate()) {
    ...
    appointmentShoudBe(custumer, hour){
